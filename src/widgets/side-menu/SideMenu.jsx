...
import { fabricPurchaseDateLabel, fabricPurchaseDisplayName } from "@/shared/lib/store.js";
...
export function SideMenu({
  ...
  const handleItemKeyDown = useCallback((event, selectFn, editTargetKey) => {
    ...
    <>
      ...
      >
        ...
        <div className="menu-header">
          <div className="menu-brand" aria-label="Morelia">
            <img
              className="menu-logo"
              ...
              aria-hidden="true"
            />
            <span className="menu-brand-name" aria-hidden="true">
              ORELIA
            </span>
          </div>
        ...
        >
          {/* Operaciones activas */}
          <div id="operations-container" className="operations-container">
            {state.operations.map((operation) => (
              <div className="operation-row" key={operation.id}>
                <div
                  ...
                  aria-current={operation.id === state.activeId ? "true" : undefined}
                  onClick={() => scheduleSelect(() => actions.selectOperation(operation.id))}
                  onDoubleClick={() => triggerEdit(`operation:${operation.id}`)}
                  onKeyDown={(e) => handleItemKeyDown(
                    e,
                ...
                >
                  <EditableText
                    ...
                    editSignal={editTarget === `operation:${operation.id}` ? editSignal : 0}
                    onSave={(value) => actions.renameOperation(operation.id, value)}
                  />
                </div>
                ...
                >
                  <img src={icon("pencil")} alt="" aria-hidden="true" />
                </button>
                ...
                >
                  <img src={icon("contenedor-de-basura")} alt="" aria-hidden="true" />
                </button>
              </div>
            ))}
          </div>
          ...
          <div className="deleted-operations-section">
            <span className="deleted-operations-title">Operaciones eliminadas</span>
            <div id="deleted-operations-container" className="deleted-operations-container">
              {state.deletedOperations.length ? (
                state.deletedOperations.map((operation) => (
                  <div className="deleted-operation-row" key={operation.id}>
                    <span className="deleted-operation-name">{operation.name}</span>
                    <div className="deleted-operation-actions">
                      ...
                      >
                        <img src={icon("restore")} alt="" aria-hidden="true" />
                      </button>
                      <button
                        className="op-action delete"
                        type="button"
                        ...
                        onClick={() => {
                          if (window.confirm(`¿Eliminar definitivamente "${operation.name}"?`)) {
                ...
                <p className="deleted-empty">No hay operaciones eliminadas.</p>
              )}
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div id="fabric-pages-container" className="operations-container">
            {fabrics.map((fabricPurchase) => (
              <div className="operation-row" key={fabricPurchase.id}>
                <div
                  ...
                  aria-current={fabricPurchase.id === active?.activeFabricId ? "true" : undefined}
                  onClick={() => scheduleSelect(() => actions.selectFabricPage(fabricPurchase.id))}
                  onDoubleClick={() => triggerEdit(`fabric:${fabricPurchase.id}`)}
                  onKeyDown={(e) => handleItemKeyDown(
                    e,
                ...
                >
                  <EditableText
                    ...
                    editSignal={editTarget === `fabric:${fabricPurchase.id}` ? editSignal : 0}
                    onSave={(value) => actions.renameFabricPage(fabricPurchase.id, value)}
                  />
                </div>
          ...
          <div className="fabric-deleted-section">
            <span className="deleted-operations-title">Compras eliminadas</span>
            <div id="deleted-fabric-pages-container" className="deleted-operations-container">
              {deletedFabrics.length ? (
                deletedFabrics.map((fabricPurchase) => (
                  <div className="deleted-operation-row" key={fabricPurchase.id}>
                    ...
                    <div className="deleted-operation-actions">
                      <button
                        ...
                        title="Restaurar"
                        onClick={() => actions.restoreFabricPage(fabricPurchase.id)}
                      >
                        <img src={icon("restore")} alt="" aria-hidden="true" />
                      </button>
                      <button
                        ...
                        title="Eliminar definitivamente"
                        onClick={() => {
                          if (window.confirm("¿Eliminar definitivamente esta compra?")) {
                ...
                <p className="deleted-empty">No hay compras de telas eliminadas.</p>
              )}
            </div>
          </div>
        </div>
        ...
        >
          <div className="settings-layer-header">
            ...
            >
              <img className="settings-back-icon" src={icon("return")} alt="" aria-hidden="true" />
              <span>volver</span>
            </button>
            <span className="settings-layer-title">
              <img className="settings-inline-icon" src={icon("settings")} alt="" aria-hidden="true" />
          ...
          <div className="settings-layer-content">
            ...
            <div className="settings-card">
              ...
              >
                <span className="settings-toggle-main">
                  <img className="settings-inline-icon" src={icon("mode_dark")} alt="" aria-hidden="true" />
            ...
            >
              ...
              <span id="user-email-text" className="account-email-text">
                {user?.email || ""}
              </span>
              <button
                id="logout-btn"
